...
import { Inbox, Image as ImageIcon, Video, BookOpen, LogOut, FolderOpen, Sliders } from "lucide-react";
...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { name: "MODEL DETAILS", href: "/tm-private-dashboard-x9k7/model-details", icon: Sliders },
  ];
